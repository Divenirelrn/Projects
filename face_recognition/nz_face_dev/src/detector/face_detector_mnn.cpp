...
Retinaface::Retinaface(
    std::string &mnn_path, int img_size, float threshold, float nms, int num_thread, bool retinaface) : _threshold(threshold),
                                                                                                        _nms(nms),
...
void Retinaface::face_detect(cv::Mat &img, std::vector<landmark> &boxes)
{
    ...
    //	std::string output[3] = { "585", "output0","586" };
